...
const showcaseProjects = [
  ...
  { id: 'woodbine-casino-hotel', title: 'Woodbine Casino Hotel', description: 'Commercial hospitality project management experience for Krisro Metal Industries.', image: 'img/project-woodbine-casino-hotel.jpg', images: ['img/project-woodbine-casino-hotel.jpg', 'img/Woodbine-Casino-Resort-Toronto-1-.jpg'], location: 'Toronto, Ontario', type: 'Commercial', scope: 'PM for Krisro Metal Industries', criteria: 'Commercial envelope delivery' },
  { id: '81-bay-st', title: '81 Bay St.', description: 'Commercial high-rise project management experience for Tagg Industries.', image: 'img/project-81-bay-toronto.jpg', images: ['img/project-81-bay-toronto.jpg', 'img/81-Bay-St.-Toronto.jpg'], location: 'Toronto, Ontario', type: 'Commercial', scope: 'PM for Tagg Industries', criteria: 'Commercial facade delivery' },
  { id: '141-bay-st-toronto', title: '141 Bay St.', description: 'Commercial tower project management experience delivered for BESI.', image: 'img/project-141-bay-toronto.jpg', images: ['img/project-141-bay-toronto.jpg'], location: 'Toronto, Ontario', type: 'Commercial', scope: 'PM for BESI', criteria: 'Commercial facade delivery' },
  { id: 'forma-266-king-st-w', title: 'Forma (266 King St. W)', description: 'Commercial tower project management experience delivered for BESI.', image: 'img/project-forma-266-king.jpg', images: ['img/project-forma-266-king.jpg', 'img/Forma-1.jpg'], location: 'Toronto, Ontario', type: 'Commercial', scope: 'PM for BESI', criteria: 'Commercial facade delivery' },
];
