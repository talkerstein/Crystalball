...
const showcaseProjects = [
  { id: '1620-main-st-hamilton', title: '1620 Main St.', description: 'Passive House low-rise residential project delivered in cooperation with BESI.', image: 'img/project-1620-main-hamilton.jpg', images: ['img/project-1620-main-hamilton.jpg', 'img/project-1620-main-hamilton-2.webp', 'img/project-1620-main-hamilton-3.webp'], location: 'Hamilton, Ontario', type: 'Low-Rise Residential', scope: 'Technical advisory for Besi', criteria: 'Passive House' },
  { id: '82-wilson-ave', title: '82 Wilson Ave.', description: 'Low-rise residential envelope project delivered in cooperation with Trust Pro Build.', image: 'img/project-82-wilson-kitchener.jpeg', images: ['img/project-82-wilson-kitchener.jpeg', 'img/project-82-wilson-kitchener-2.webp', 'img/project-82-wilson-kitchener-3.webp'], location: 'Kitchener, Ontario', type: 'Low-Rise Residential', scope: 'Technical advisory for Trust Pro Build', criteria: 'Low-rise residential envelope' },
  { id: '216-murray-st-ottawa', title: '216 Murray St.', description: 'Low-rise residential project experience in Ottawa.', image: 'img/project-216-murray-ottawa.jpg', images: ['img/project-216-murray-ottawa.jpg', 'img/project-216-murray-ottawa-2.webp', 'img/project-216-murray-ottawa-3.webp', 'img/project-216-murray-ottawa-4.webp', 'img/project-216-murray-ottawa-5.webp', 'img/project-216-murray-ottawa-6.webp'], location: 'Ottawa, Ontario', type: 'Low-Rise Residential', scope: 'Technical advisory for Low rise residential envelope', criteria: 'Low-rise residential envelope' },
  { id: 'algonquin-custom-home', title: 'Algonquin', description: '', image: 'img/project-algonquin-1.jpg', images: ['img/project-algonquin-1.jpg', 'img/project-algonquin-2.jpg', 'img/project-algonquin-3.jpg', 'img/project-algonquin-4.jpg'], location: 'Ontario', type: 'Low-Rise Residential', categories: ['Low-Rise Residential', 'Custom Home'], scope: 'Technical advisory for Trust Pro Build', criteria: 'Custom home envelope' },
  { id: 'woodbine-casino-hotel', title: 'Woodbine Casino Hotel', description: 'Commercial hospitality project management experience for Krisro Metal Industries.', image: 'img/project-woodbine-casino-hotel.jpg', images: ['img/project-woodbine-casino-hotel.jpg', 'img/project-woodbine-casino-hotel-2.webp', 'img/project-woodbine-casino-hotel-3.webp'], location: 'Toronto, Ontario', type: 'Commercial', scope: 'Senior PM for Krisro Metal Industries', criteria: 'Commercial envelope delivery' },
  { id: '81-bay-st', title: '81 Bay St.', description: 'Commercial high-rise project management experience for Tagg Industries.', image: 'img/project-81-bay-toronto.jpg', location: 'Toronto, Ontario', type: 'Commercial', scope: 'Senior PM for Tagg Industries', criteria: 'Commercial facade delivery' },
  { id: '141-bay-st-toronto', title: '141 Bay St.', description: 'Commercial tower project management experience delivered for BESI.', image: 'img/project-141-bay-toronto.jpg', location: 'Toronto, Ontario', type: 'Commercial', scope: 'Senior PM for BESI', criteria: 'Commercial facade delivery' },
  { id: 'forma-266-king-st-w', title: 'Forma (266 King St. W)', description: 'Commercial tower project management experience delivered for BESI.', image: 'img/project-forma-266-king.jpg', images: ['img/project-forma-266-king.jpg', 'img/project-forma-266-king-2.webp', 'img/project-forma-266-king-3.webp'], location: 'Toronto, Ontario', type: 'Commercial', scope: 'Senior PM for BESI', criteria: 'Commercial facade delivery' },
];
